...
Currently available applets include:
	...
	[, [[, acpid, ar, ash, awk, basename, bbconfig, beep, blkdiscard,
	blkid, blockdev, bzcat, bzip2, cal, cat, chattr, chgrp, chmod,
	chown, chroot, chrt, chvt, cksum, clear, cmp, comm, cp, cpio, cut,
	date, dd, deallocvt, depmod, devmem, df, diff, dirname, dmesg,
	dnsdomainname, du, dumpkmap, echo, ed, egrep, eject, env,
	ether-wake, expand, expr, factor, fallocate, false, fatattr, fbset,
	fbsplash, fdisk, fgconsole, fgrep, find, findfs, flock, fold, free,
	freeramdisk, fsck, fsck.minix, fsfreeze, fstrim, fsync, ftpget,
	ftpput, fuser, getopt, getty, grep, groups, gzip, halt, hd, hdparm,
	head, hexdump, hexedit, hostid, hostname, hwclock, i2cdetect,
	...
	iprule, iptunnel, kbd_mode, kill, killall, killall5, last, less,
	link, linuxrc, ln, loadfont, loadkmap, logname, losetup, ls, lsattr,
	lsmod, lsof, lspci, lsscsi, lsusb, lzma, lzop, makedevs, man,
	md5sum, mdev, microcom, mim, mkdir, mkdosfs, mke2fs, mkfifo,
	mkfs.ext2, mkfs.minix, mkfs.vfat, mknod, mkswap, mktemp, modinfo,
	...
	paste, patch, pgrep, pidof, ping, ping6, pivot_root, pkill, pmap,
	poweroff, powertop, printenv, printf, ps, pscan, pstree, pwd, pwdx,
	raidautorun, rdate, rdev, readahead, readlink, readprofile,
	realpath, reboot, renice, reset, resize, rev, rm, rmdir, rmmod,
	route, rtcwake, runlevel, rx, script, scriptreplay, sed, seq,
	setconsole, setfattr, setfont, setkeycodes, setlogcons, setpriv,
	setserial, setsid, sh, sha1sum, sha256sum, sha512sum, showkey,
	shred, shuf, slattach, sleep, smemcap, sort, split, stat, strings,
	stty, su, sum, swapoff, swapon, switch_root, sync, sysctl, tac,
	tail, tar, taskset, tee, test, tftp, time, timeout, top, touch, tr,
	traceroute, traceroute6, true, truncate, ts, tty, ttysize, tunctl,
	ubiattach, ubidetach, ubimkvol, ubirename, ubirmvol, ubirsvol,
	ubiupdatevol, udhcpc, udhcpc6, uevent, umount, uname, unexpand,
	uniq, unlink, unshare, unzip, uptime, users, usleep, uudecode,
	uuencode, vconfig, vi, vlock, volname, wall, watch, watchdog, wc,
	wget, whois, xargs, xxd, xz, yes, zcip
