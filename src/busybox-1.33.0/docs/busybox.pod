...
Currently available applets include:
	...
	[, [[, ash, basename, beep, blkid, bzip2, cat, chattr, chroot,
	clear, cp, cpio, cut, date, dd, df, dirname, dmesg, du, echo, egrep,
	env, expand, expr, factor, false, fdisk, fgrep, find, fold, free,
	fsck, fsck.minix, grep, gzip, halt, head, hostid, id, init, insmod,
	ionice, ipcrm, kill, link, linuxrc, ln, logname, ls, lsattr, lspci,
	lsusb, lzma, lzop, mdev, mkdir, mkdosfs, mke2fs, mkfs.ext2,
	mkfs.minix, mkfs.vfat, mknod, mkswap, more, mount, mountpoint, mv,
	nanddump, nsenter, pivot_root, pkill, poweroff, printenv, printf,
	ps, pwd, pwdx, rdate, rdev, readlink, readprofile, realpath, reboot,
	renice, rev, rm, rmdir, rmmod, rtcwake, runlevel, script,
	scriptreplay, sed, seq, setpriv, setsid, sh, shred, shuf, sleep,
	sort, stat, stty, sum, swapoff, swapon, switch_root, sync, tail,
	tar, taskset, tee, test, touch, tr, true, truncate, tty, uevent,
	umount, uname, unexpand, unshare, unzip, uptime, vi, wall, xz
